...
[CustomEditor(typeof(RandomBoardData), false), CanEditMultipleObjects]
public class RandomBoardDataEditor : Editor
{
    private RandomBoardData boardData => target as RandomBoardData;
