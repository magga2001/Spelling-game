...
public class RandomWordGrid : MonoBehaviour
{
    [SerializeField] private RandomBoardData boardData;
    ...
    private void Update()
    {
        ...
        {
            InstantiateRandomWordGrid();
        }
    }

    public void InstantiateRandomWordGrid()
    {
